//
//  EnterOneCupConfirmController.swift
//  WaterBottle
//
...
class EnterOneCupConfirmController: UIViewController {
    var daily_values = [Double]()
    ...
    lazy var titleLabelCups: UILabel = {
        ...
        let currentDayKey2 = EnterOneCupConfirmController.getCurrentDay() + ":day"
    ...
    let enterButton: UIButton = {
        ...
        let enterAttributeTitle = NSMutableAttributedString(string: "Confirm 1-Cup Intake",
    ...
    let pieChart: PieChartView = {
        ...
        var getArr = UserDefaults.standard.array(forKey: EnterOneCupConfirmController.getCurrentDay()) as? [Double]
        var getLabel = UserDefaults.standard.array(forKey: EnterOneCupConfirmController.getCurrentDay() + ":label") as? [String]
        
        // delete date
//        let currentDayKey = EnterOneCupConfirmController.getCurrentDay()
//        UserDefaults.standard.removeObject(forKey: currentDayKey)
//        UserDefaults.standard.removeObject(forKey: currentDayKey + ":label")
//        UserDefaults.standard.removeObject(forKey: currentDayKey + ":day")
    ...
    override func viewDidLoad() {
        ...
        let newDayKey = EnterOneCupConfirmController.getCurrentDay()
        ...
        let newDayKey1 = EnterOneCupConfirmController.getCurrentDay() + ":label"
    ...
    @objc func home_page() {
        ...
        // label
        let currentDayKey1 = EnterOneCupConfirmController.getCurrentDay() + ":label"
        ...
        if UserDefaults.standard.object(forKey: currentDayKey1) != nil {
            ...
            labelArr.append(EnterOneCupConfirmController.getCurrentTime())
        ...
        UserDefaults.standard.set(1, forKey: "last_consumption")
